  ...
  <main id="main" class="main">
    ...
    <div class="row">
      ...
      <div class="card">
        ...
        <td>
          <div class="dropdown">
            <span id="badge-estado-{{ $item->id }}" class="badge estado-badge {{ $item->estado == 'Espera' ? 'bg-info' : ($item->estado == 'Deuda' ? 'bg-danger' : ($item->estado == 'Pagado' ? 'bg-success' : 'bg-danger')) }}" 
            ...
            <ul class="dropdown-menu" aria-labelledby="badge-estado-{{ $item->id }}">
              <li><a class="dropdown-item cambiar-estado" href="#" data-id="{{ $item->id }}" data-estado="Espera">Espera</a></li>
              <li><a class="dropdown-item cambiar-estado" href="#" data-id="{{ $item->id }}" data-estado="Deuda">Deuda</a></li>
              <li><a class="dropdown-item cambiar-estado" href="#" data-id="{{ $item->id }}" data-estado="Pagado">Pagado</a></li>
            </ul>
          </div>
